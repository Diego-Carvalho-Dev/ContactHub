    ...
    <StyleCardContact key={elem.id}>
      <div className="areaClient">
        ...
        <div class="butt">
          ...
          ><img className="btEdit" src={import.meta.env.BASE_URL + 'images/edit.png'} alt="" width={130} height={100} /></button>
          <button
            type="button"
            onClick={() => removeContact(elem.id)}
            className="btDelete"
          ><img className="btDelete" src={import.meta.env.BASE_URL + 'images/trash.png'} alt="" width={130} height={100} /></button>
        </div>
      </div>
